...
enum opt_code
{
  ...
  OPT_mbit_align = 1213,                     /* -mbit-align */
  OPT_mbit_word = 1214,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1215,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 1216,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 1217,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1218,                       /* -mbss-plt */
  OPT_mcall_ = 1219,                         /* -mcall- */
  OPT_mcmpb = 1220,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1221,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1222,                          /* -mcpu= */
  OPT_mcrypto = 1223,                        /* -mcrypto */
  OPT_mdebug_ = 1224,                        /* -mdebug= */
  /* OPT_mdirect_move = 1225, */             /* -mdirect-move */
  OPT_mdlmzb = 1226,                         /* -mdlmzb */
  OPT_mdouble_float = 1227,                  /* -mdouble-float */
  OPT_meabi = 1228,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1229,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1230,                           /* -memb */
  OPT_mfloat128 = 1231,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1232,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1233,             /* -mfloat128-hardware */
  OPT_mfold_gimple = 1234,                   /* -mfold-gimple */
  OPT_mfp_in_toc = 1235,                     /* -mfp-in-toc */
  OPT_mfprnd = 1236,                         /* -mfprnd */
  OPT_mfpu_ = 1237,                          /* -mfpu= */
  OPT_mfriz = 1238,                          /* -mfriz */
  OPT_mfull_toc = 1239,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1240, */              /* -mfused-madd */
  OPT_mgcbios = 1241,                        /* -mgcbios */
  OPT_mgcn = 1242,                           /* -mgcn */
  ...
  OPT_mmvme = 1263,                          /* -mmvme */
  OPT_mnewlib = 1264,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1265,                  /* -mno-fp-in-toc */
  /* OPT_mno_string = 1266, */               /* -mno-string */
  OPT_mno_sum_in_toc = 1267,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1268,                        /* -mno-toc */
  OPT_mno_traceback = 1269,                  /* -mno-traceback */
  OPT_mno_update = 1270,                     /* -mno-update */
  OPT_mogc = 1271,                           /* -mogc */
  ...
  OPT_mrvl = 1299,                           /* -mrvl */
  OPT_msave_toc_indirect = 1300,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1301,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1302,                  /* -msched-epilog */
  OPT_msched_groups = 1303,                  /* -msched-groups */
  OPT_msched_prolog = 1304,                  /* -msched-prolog */
  OPT_msdata = 1305,                         /* -msdata */
  OPT_msdata_ = 1306,                        /* -msdata= */
  OPT_msecure_plt = 1307,                    /* -msecure-plt */
  OPT_mshlib = 1308,                         /* -mshlib */
  OPT_msim = 1309,                           /* -msim */
  OPT_msimple_fpu = 1310,                    /* -msimple-fpu */
  OPT_msingle_float = 1311,                  /* -msingle-float */
  OPT_msingle_pic_base = 1312,               /* -msingle-pic-base */
  OPT_msoft_float = 1313,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 1314,      /* -mspeculate-indirect-jumps */
  OPT_mstack_protector_guard_offset_ = 1315, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1316,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1317,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1318,                  /* -mstrict-align */
  OPT_mstring = 1319,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1320,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1321,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1322,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1323,                   /* -mtls-markers */
  OPT_mtls_size_ = 1324,                     /* -mtls-size= */
  OPT_mtoc = 1325,                           /* -mtoc */
  OPT_mtoc_fusion = 1326,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1327,                    /* -mtraceback= */
  OPT_mtune_ = 1328,                         /* -mtune= */
  OPT_mupdate = 1329,                        /* -mupdate */
  OPT_mveclibabi_ = 1330,                    /* -mveclibabi= */
  OPT_mvgc = 1331,                           /* -mvgc */
  OPT_mvrsave = 1332,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1333, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1334, */              /* -mvrsave=yes */
  OPT_mvsx = 1335,                           /* -mvsx */
  OPT_mvsx_align_128 = 1336,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 1337, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1338,             /* -mwarn-altivec-long */
  OPT_mwup = 1339,                           /* -mwup */
  ...
  OPT_quiet = 1372,                          /* -quiet */
  OPT_r = 1373,                              /* -r */
  OPT_remap = 1374,                          /* -remap */
  OPT_s = 1375,                              /* -s */
  OPT_save_temps = 1376,                     /* -save-temps */
  OPT_save_temps_ = 1377,                    /* -save-temps= */
  OPT_shared = 1378,                         /* -shared */
  OPT_shared_libgcc = 1379,                  /* -shared-libgcc */
  /* OPT_specs = 1380, */                    /* -specs */
  OPT_specs_ = 1381,                         /* -specs= */
  OPT_static = 1382,                         /* -static */
  OPT_static_libasan = 1383,                 /* -static-libasan */
  OPT_static_libgcc = 1384,                  /* -static-libgcc */
  ...
  /* OPT_std_c89 = 1407, */                  /* -std=c89 */
  OPT_std_c90 = 1408,                        /* -std=c90 */
  OPT_std_c99 = 1409,                        /* -std=c99 */
  /* OPT_std_c9x = 1410, */                  /* -std=c9x */
  OPT_std_f2003 = 1411,                      /* -std=f2003 */
  OPT_std_f2008 = 1412,                      /* -std=f2008 */
  OPT_std_f2008ts = 1413,                    /* -std=f2008ts */
  OPT_std_f2018 = 1414,                      /* -std=f2018 */
  OPT_std_f95 = 1415,                        /* -std=f95 */
  OPT_std_gnu = 1416,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1417, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1418, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1419,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1420,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1421,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1422, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1423, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1424,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1425,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1426,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1427,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1428, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1429, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1430, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1431,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1432,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1433, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1434, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1435,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1436, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1437, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1438, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1439, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1440, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1441,                     /* -std=legacy */
  OPT_symbolic = 1442,                       /* -symbolic */
  OPT_t = 1443,                              /* -t */
  OPT_time = 1444,                           /* -time */
  OPT_time_ = 1445,                          /* -time= */
