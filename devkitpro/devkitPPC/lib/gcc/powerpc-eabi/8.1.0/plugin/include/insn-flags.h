...
#define HAVE_negif2_internal ((TARGET_HARD_FLOAT && FLOAT128_IBM_P (TFmode)) && (FLOAT128_IBM_P (IFmode)))
...
#define HAVE_move_from_CR_ov_bit (TARGET_PAIRED_FLOAT)
...
#define HAVE_negv2sf2 (TARGET_PAIRED_FLOAT)
#define HAVE_sqrtv2sf2 (TARGET_PAIRED_FLOAT)
#define HAVE_absv2sf2 (TARGET_PAIRED_FLOAT)
#define HAVE_nabsv2sf2 (TARGET_PAIRED_FLOAT)
#define HAVE_addv2sf3 (TARGET_PAIRED_FLOAT)
#define HAVE_subv2sf3 (TARGET_PAIRED_FLOAT)
#define HAVE_mulv2sf3 (TARGET_PAIRED_FLOAT)
#define HAVE_resv2sf2 (TARGET_PAIRED_FLOAT && flag_finite_math_only)
#define HAVE_divv2sf3 (TARGET_PAIRED_FLOAT)
...
#define HAVE_vec_initv2sfsf (TARGET_PAIRED_FLOAT)
